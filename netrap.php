...
<li><a href="netrap.php">Web</a></li>
                  ...
                  <div class="row" style="padding-left:100px;padding-right:100px;">
                         <div class="4u 12u$(medium)">
							...
							<table>
								<td><img src="images/web.png" height="100px" width="100px"/>
								...
								<h1>First Day</h1>
								<p><b>First slot:</b> Basics of html5<b><br>Second slot:</b> Basics of php and wamp</p>    
								<h1>Second day</h1>
								<p><b>First slot:</b>Hands on with some sample projects<b><br>Second slot:</b>Hosting and Databases<b><br>Third slot:</b>Contest based on the workshop</p>
							     <div class="12u$">
										<ul class="actions">
											<a href="signup.php"><li><input type="submit" value="Register for #NetRap" class="special" /></li></a>
										</ul>
									</div>
								</center>
							</section>
